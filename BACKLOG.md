...
| S7.4 | [feature] | Pinned-RAM staging + layer paging from system RAM to VRAM (Sprint 7 step 4) — fit 13B-class models on the 5700 XT's 8 GB VRAM by streaming layers through a pinned staging buffer. | Safetensors loader (S7.3) |
| S7.5 | [feature] | f16 storage type via `shader-f16` wgpu feature (Sprint 7 step 5) — 2× bandwidth on RDNA1. | Safetensors loader (S7.3) |
